...
export default function WorkspacePage() {
  return (
    <div className="min-h-screen mt-16 bg-gradient-to-br from-background to-secondary text-foreground font-sans relative overflow-hidden">
      ...
      <div className="h-[85.5vh] overflow-scroll scrollbar-hide mt-1 md:w-1/3">
        <Chatspace />
      </div>
      <div className="h-[91%] md:w-2/3">
        <Codespace />
      </div>
    </div>
